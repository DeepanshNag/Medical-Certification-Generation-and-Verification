...
class DoctorOtpPhoneScreen extends StatefulWidget {
  final String registrationNumber;

  DoctorOtpPhoneScreen({Key? key, required this.registrationNumber})
      : super(key: key);

  @override
  State<DoctorOtpPhoneScreen> createState() => _DoctorOtpPhoneScreenState();
}

class _DoctorOtpPhoneScreenState extends State<DoctorOtpPhoneScreen> {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Doctor enter the OTP sent to your mobile number ',
                  style: TextStyle(
                    fontSize: 18,
                    color: Colors.black,
                  ),
                  ...
                  onTap: () async {
                    ...
                    if (jsonResponse["res"] == 'success') {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => DoctorResetPasswordScreen(
