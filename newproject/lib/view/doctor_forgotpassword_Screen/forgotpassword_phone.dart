...
class DoctorForgetPasswordPhoneScreen extends StatefulWidget {
  final String registrationNumber;

  DoctorForgetPasswordPhoneScreen({Key? key, required this.registrationNumber})
      : super(key: key);
  @override
  _DoctorForgetPasswordPhoneScreenState createState() =>
      _DoctorForgetPasswordPhoneScreenState();
}

class _DoctorForgetPasswordPhoneScreenState
    extends State<DoctorForgetPasswordPhoneScreen> {
  TextEditingController _phone = TextEditingController();
  TextEditingController _doctorRegistrationNo2 =
      TextEditingController(); // Add controller for registration number
  TextEditingController _doctorPassword2 =
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 20),
              const Text(
                'Doctor enter your phone number to reset your password',
                style: TextStyle(
                  fontSize: 23,
                  color: Colors.black,
                ),
